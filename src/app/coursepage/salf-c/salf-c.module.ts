...
import { SalfCComponent } from './salf-c.component';
...
@NgModule({
  declarations: [SalfCComponent, PricefsdComponent, CctfsdComponent, 
  ],
  imports: [
    CommonModule,
    ...
    {
    path: '',
    component: SalfCComponent
    }
    ])
  ] 
})
export class SalfCModule { }
